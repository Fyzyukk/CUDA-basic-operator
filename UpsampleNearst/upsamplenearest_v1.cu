...
__global__ void upsampleNearest(const float* input, float* output, int input_width,
                                        int input_height) {
    ...
    int in_x = min((int)((float)out_x / output_width * input_width),
                                                    input_width - 1);
    int in_y = min((int)((float)out_y / output_height * input_height),
                                                    input_height - 1);
